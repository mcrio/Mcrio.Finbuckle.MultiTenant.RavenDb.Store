...
/// <summary>
/// Extension methods to <see cref="MultiTenantBuilder{TTenantInfo}"/> for adding RavenDB stores.
/// </summary>
public static class FinbuckleMultiTenantBuilderExtension
{
    ...
    public static MultiTenantBuilder<TTenantInfo> WithRavenDbStore<TTenantInfo>(
    ...
    /// <returns>Multi tenant builder.</returns>
    public static MultiTenantBuilder<TTenantInfo> WithRavenDbStore<
        TTenantInfo,
        TRavenDbStore>(
        this MultiTenantBuilder<TTenantInfo> builder,
        DocumentSessionServiceLocator documentSessionServiceLocator,
